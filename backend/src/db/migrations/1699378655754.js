module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('work_orders', 'order_date', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('raw_materials', 'stock_quantity', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('quality_checks', 'passed', {
        transaction,
      });

      await queryInterface.removeColumn('quality_checks', 'check_stage', {
        transaction,
      });

      await queryInterface.removeColumn('quality_checks', 'check_date', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('inventories', 'returned_quantity', {
        transaction,
      });

      await queryInterface.removeColumn('inventories', 'reserved_quantity', {
        transaction,
      });

      await queryInterface.removeColumn('inventories', 'available_quantity', {
        transaction,
      });

      await queryInterface.removeColumn('inventories', 'product_name', {
        transaction,
      });

      await queryInterface.removeColumn('employees', 'pay_rate', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('users', 'userInfo', { transaction });
      ...
      await queryInterface.dropTable('quality_checks', { transaction });
